...
BOARD_AVB_RECOVERY_KEY_PATH := vendor/lineage-priv/keys/avb_user_key.pem
BOARD_AVB_RECOVERY_ALGORITHM := SHA256_RSA4096
BOARD_AVB_RECOVERY_ROLLBACK_INDEX := 1
BOARD_AVB_RECOVERY_ROLLBACK_INDEX_LOCATION := 1

BOARD_AVB_VBMETA_SYSTEM := product system_ext system
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := vendor/lineage-priv/keys/avb_user_key.pem
BOARD_AVB_VBMETA_SYSTEM_ALGORITHM := SHA256_RSA4096
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX := 1
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX_LOCATION := 2

BOARD_AVB_VBMETA_VENDOR := vendor odm
BOARD_AVB_VBMETA_VENDOR_KEY_PATH := vendor/lineage-priv/keys/avb_user_key.pem
...
#AVB HASH
BOARD_AVB_SYSTEM_HASH_ALGORITHM := sha256
BOARD_AVB_VENDOR_HASH_ALGORITHM := sha256
BOARD_AVB_PRODUCT_HASH_ALGORITHM := sha256
BOARD_AVB_SYSTEM_EXT_HASH_ALGORITHM := sha256
